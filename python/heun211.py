"""
This program implements the Heun Method for solving 
the IVP y' = f(x,y), y(x0) = y0.
This method comes from Ch21.1, and hence "heun211".  
...
def heun211(x0,y0,h,N):  #This defines the program as a function. 
    ...
    for n in range(0,N): #This loop computes the numerical solution values
        ...
        k2 = h*f(x[n+1],y[n]+k1)  #k2 uses predictor slope
        y[n+1] = y[n] + 0.5*(k1+k2)  #corrector value
    
    print('Heun Solution=', y)     #Print numerical solution y-values
