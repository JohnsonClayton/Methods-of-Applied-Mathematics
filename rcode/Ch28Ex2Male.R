Ch28Ex2Male <- function(W) {

  #Chapter2.8 Model I: Full Stomach, three drinks at start, male.
  ...
  plot(t,x,               #Use line breaks to see plot options
        main = "Model I: Three Drinks at Start on Full Stomach (Male)",
        xlab = "t (hours)",           #x-axis label
        ylab = "BAL (g/100 ml)",      #y-axis label
        type="l",col="blue", 
        xlim=c(0,T),                  #x-axis range
        ylim=c(0,0.08)                #y-axis range
       )
